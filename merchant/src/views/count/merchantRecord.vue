  ...
  <div class="full-height">
    <div class="app-container">
      <el-card class="filter-container">
        <el-row>
          <el-col class="title-color" :span="4" style="line-height: 40px; font-weight: bold;">码商库存变动</el-col>
          <el-col :span="20">
      ...
      <el-card>
        ...
        >
          ...
          <el-table-column align="center" label="商品ID" prop="shopId" />
          <el-table-column align="center" label="操作前库存" prop="shopOldNum" />
          <el-table-column align="center" label="当前库存" prop="shopNowNum" />
          <el-table-column align="center" label="变动库存">
            <template slot-scope="scope">
              {{ scope.row.type + scope.row.shopNum }}
            </template>
          </el-table-column>
